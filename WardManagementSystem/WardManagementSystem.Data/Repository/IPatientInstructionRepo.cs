...
namespace WardManagementSystem.Data.Repository
{
    ...
    {
        Task<bool> AddAsync(Patient_Instruction patient_instruction, int DoctorID);
        ...
        Task<IEnumerable<PatientInstructionViewModel>> GetAllPatientNameAsync(int PatientFileID, int DoctorID);
    }
}
